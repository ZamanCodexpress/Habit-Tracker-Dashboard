...
const App = {
  ...
  setupEventListeners() {
    ...
    document
      .querySelector("#habitModal .modal-overlay")
    ...
    document
      .querySelector("#deleteModal .modal-overlay")
      ?.addEventListener("click", () => {
        this.closeDeleteModal();
      });
  },
    ...
    if (habitId) {
      ...
      document.querySelectorAll(".frequency-option").forEach((btn) => {
        btn.classList.toggle(
          "selected",
          btn.dataset.frequency === habit.frequency,
        );
      });
    } else {
      // Add mode
      ...
      // Set defaults
      document
        .querySelector('.color-option[data-color="#845EC2"]')
        ?.classList.add("selected");
      document
        .querySelector('.frequency-option[data-frequency="daily"]')
        ?.classList.add("selected");
    }
  ...
  saveHabit() {
    ...
    const color =
      ...
      "#845EC2";
    const frequency =
      document.querySelector(".frequency-option.selected")?.dataset.frequency ||
      "daily";
  ...
  renderManageHabits() {
    ...
    if (habits.length === 0) {
      ...
      setTimeout(() => {
        document
          .getElementById("btnDeleteAllEmpty")
